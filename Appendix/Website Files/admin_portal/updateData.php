...
function updateData($symptom, $type, $basicFacts, $control, $diagnostics, $id)
{
	try {
		...
		$stmt = $dbh->prepare("UPDATE glossary SET symptom= :symptom, type= :type,  basicFacts = :basicFacts, control = :control, diagnostics = :diagnostics, timestamp = datetime(:timestamp) WHERE _id= :id");
