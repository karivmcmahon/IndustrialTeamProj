...
public class FurtherInfoDataSource extends BaseDataSource {
	private String[] furtherInfoColumnsQuery = { GLOSSARY_ID, GLOSSARY_SYMPTOM, GLOSSARY_TYPE, GLOSSARY_IMAGE1, GLOSSARY_IMAGE2,
			GLOSSARY_IMAGE3, GLOSSARY_IMAGE3, GLOSSARY_IMAGE4, GLOSSARY_IMAGE5, GLOSSARY_IMAGE6, GLOSSARY_BASIC_FACTS, GLOSSARY_CONTROL,
	...
	public List<FurtherInfoBean> getFurtherInfo(String symptom) {
		...
		Cursor cursor = database.query(GLOSSARY_TABLE, furtherInfoColumnsQuery, GLOSSARY_SYMPTOM + "=?", new String[] { symptom }, null,
				null, null);
