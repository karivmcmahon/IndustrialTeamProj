...
/*
 * Class for handling the "expert system"
 */
...
public class QuestionFragment extends BaseFragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		// layout that this fragment will use.
		v = inflater.inflate(R.layout.question_fragment_layout, container, false);

		// Initializing the buttons and text views that the class will be using.
	...
	protected void refresh() {
		// if it has found out what the answer to the diagnosis is then start a
		// new fragment to the class which displays a virus in detail
	...
	private int buttonIds[] = { R.id.slideshow_btn1, R.id.slideshow_btn2, R.id.slideshow_btn3, R.id.slideshow_btn4, R.id.slideshow_btn5,
			R.id.slideshow_btn6 };

	// shows which image in the slideshow you are on by changing the appearance
	// of the equivalent button for the slideshow image
